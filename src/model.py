...
class BinarySLUTagger(nn.Module):
    def __init__(self, params, vocab):
        ...
        #=============
        '''
        self.lower_lstm = Lstm(params, vocab)
        self.higher_lstm = Lstm(params, vocab)
        '''
        #==============
    ...
    def forward(self, X, lengths=None):
        ...
        '''
        lower_lstm_hidden = self.lower_lstm(X)
        higher_lstm_hidden = self.higher_lstm(lower_lstm_hidden)
        prediction = self.linear(higher_lstm_hidden)
        
        return prediction, lower_lstm_hidden, higher_lstm_hidden
        '''
